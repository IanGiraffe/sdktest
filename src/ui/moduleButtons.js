  ...
  const modules = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'activateLensLayer' },
        { name: 'addProjectLayer' },
        { name: 'addTempLayer' },
        { name: 'addTempLayerGeoJSON' },
        { name: 'createDrawingLayer' },
        { name: 'createGeoJSONLayer' },
        { name: 'createLayer' },
        { name: 'deactivateLensLayer' },
        { name: 'deleteDrawingLayer' },
        { name: 'deleteProjectLayer' },
        { name: 'duplicateDrawingLayer' },
        { name: 'getLayerContents', handler: makeHandler(byId.get('composite.layer.testLayerContents')) },
        { name: 'getLayerPermission' },
        { name: 'removeTempLayer' },
        { name: 'renameDrawingLayer' },
        { name: 'setTiles' },
        { name: 'toggleLensLayer' },
        { name: 'updateGeoJSONLayerContents' },
        { name: 'updateLayer' },
        { name: 'updateLayerStyle' },
        { name: 'updateTempLayerGeoJSON' }
      ]
    },
    {
      key: 'layerTree',
